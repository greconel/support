<div
    ...
    "
>
    <div class="modal fade" id="projectEmailModal" aria-labelledby="projectEmailModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false"
         wire:ignore.self x-ref="modal"
    >
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="projectEmailModalLabel">{{ __('Prepare new email') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <div class="modal-body">
                    <form wire:submit.prevent="send" id="projectEmailForm">
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row mb-4">
                            <div class="col">
                                <div wire:ignore>
                                    <textarea x-ref="editor" id="projectEmailEditor">{!! $content !!}</textarea>
                                </div>
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <button type="submit" class="btn btn-primary" form="projectEmailForm" wire:loading.attr="disabled" wire:target="send">
                            <span>{{ __('Send') }}</span>
    ...
    {{-- Preview modal --}}
    <div class="modal fade" id="projectEmailPreviewModal" aria-labelledby="projectEmailPreviewModalLabel" aria-hidden="true"
         wire:ignore.self x-ref="modalPreview"
    >
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="projectEmailPreviewModalLabel">{{ __('Preview email') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
