    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
        <li>
            <a
                ...
                href="{{ action(\App\Http\Controllers\Ampp\Clients\ShowClientController::class, $id) }}"
            >
        ...
        <li>
            <a
                ...
                href="{{ action(\App\Http\Controllers\Ampp\Clients\EditClientController::class, $id) }}"
            >
