<x-layouts.ampp :title="__('Edit GDPR register')" :breadcrumbs="Breadcrumbs::render('editGdprRegister', $register)">
    <div class="container">
        <x-ui.page-title>{{ __('Edit GDPR register') }}</x-ui.page-title>

        <div class="card card-body">
            <x-forms.form action="{{ action(\App\Http\Controllers\Ampp\GdprRegisters\UpdateGdprRegisterController::class, $register) }}" method="patch">
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <x-forms.select
                                ...
                                :value="$register->processing_activity"
                                :options="[
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            <x-forms.textarea name="processing_activity_input" placeholder="{{ __('Extra input or comments') }}" required>
                                {{ $register->processing_activity_input }}
                            </x-forms.textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <x-forms.select
                                ...
                                :value="$register->processing_purpose"
                                :options="[
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            <x-forms.textarea name="processing_purpose_input" placeholder="{{ __('Extra input or comments') }}" required>
                                {{ $register->processing_purpose_input }}
                            </x-forms.textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <x-forms.select
                                ...
                                :value="$register->subject_category"
                                :options="[
                                    'clients' => __('Clients'),
                                    'members' => __('Members'),
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            <x-forms.textarea name="subject_category_input" placeholder="{{ __('Extra input or comments') }}" required>
                                {{ $register->subject_category_input }}
                            </x-forms.textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            <x-forms.textarea name="data_type_input" placeholder="{{ __('Extra input or comments') }}" required>
                                {{ $register->data_type_input }}
                            </x-forms.textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <x-forms.textarea name="receiver_type" placeholder="{{ __('Extra input or comments') }}" required>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <x-forms.textarea name="retention_period" placeholder="{{ __('Extra input or comments') }}" required>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            <x-forms.textarea name="legal_basis_input" placeholder="{{ __('Extra input or comments') }}" required>
                                {{ $register->legal_basis_input }}
                            </x-forms.textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <x-forms.textarea name="transfers_to" placeholder="{{ __('Extra input or comments') }}" required>
                                {{ $register->transfers_to }}
                            </x-forms.textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <x-forms.select
                                ...
                                :value="$register->nature_transfers"
                                :options="[
                                    'no' => __('No'),
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            <x-forms.textarea name="nature_transfers_input" placeholder="{{ __('Extra input or comments') }}" required>
                                {{ $register->nature_transfers_input }}
                            </x-forms.textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <x-forms.textarea name="technical_measures" placeholder="{{ __('Extra input or comments') }}" required>
                                {{ $register->technical_measures }}
                            </x-forms.textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <x-forms.textarea name="database" placeholder="{{ __('Extra input or comments') }}" required>
                                {{ $register->database }}
                            </x-forms.textarea>
                        </div>
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <x-forms.textarea name="access" placeholder="{{ __('Extra input or comments') }}" required>
                                {{ $register->access }}
                            </x-forms.textarea>
                        </div>
                    </div>
    ...
    <x-push name="modals">
        <x-ui.confirmation-modal id="confirmDeleteModal">
            <x-slot name="content">
                {{ __('Are you sure you want to delete this GDPR register? This action can not be reverted!') }}
            </x-slot>

            <x-slot name="actions">
                <x-forms.form :action="action(\App\Http\Controllers\Ampp\GdprRegisters\DestroyGdprRegisterController::class, $register)" method="delete">
