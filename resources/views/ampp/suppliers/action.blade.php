    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
        <li>
            <a
                ...
                href="{{ action(\App\Http\Controllers\Ampp\Suppliers\ShowSupplierController::class, $id) }}"
            >
        ...
        <li>
            <a
                ...
                href="{{ action(\App\Http\Controllers\Ampp\Suppliers\EditSupplierController::class, $id) }}"
            >
