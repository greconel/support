<x-layouts.pdf>
    ...
    <div class="page">
        <div class="row mb-4">
            <div class="col-5">
                <img src="{{ asset('images/logos/bmk_logo.png') }}" class="img-fluid" style="max-height: 300px" alt="BMK logo">
            ...
            <div class="col-7 text-end">
                ...
                <p>
                    <small>
                        Offerte nr.: {{ $quotation->custom_name }} <br>
                        Offerte datum: {{ $quotation->custom_created_at->format('d/m/Y') }} <br>
                        Vervaldag: {{ $quotation->expiration_date->format('d/m/Y') }} <br>
                    </small>
                </p>
            </div>
        </div>
            ...
            <div class="col-5">
                <p>
                    @if($quotation->client->company)
                        <b>{{ $quotation->client->company }}</b> <br>
                    @endif

                    {{ $quotation->client->full_name_backwards }} <br>

                    {{ $quotation->client->street }} {{ $quotation->client->number }} <br>
                    {{ $quotation->client->postal }} {{ $quotation->client->city }} <br>
                    ...
                    @if($quotation->client->vat)
                        Btw-nummer:  {{ $quotation->client->vat }} <br>
                    @endif
                </p>
            </div>
        </div>
        ...
        <div class="row justify-content-end">
            <div class="col-6">
                <div class="d-flex justify-content-between">
                    ...
                    <p class="my-1 py-0">€ {{ number_format($quotation->amount, 2, '.', ' ') }}</p>
                </div>
                <div class="d-flex justify-content-between">
                ...
                <hr class="py-0 my-0">
                <div class="d-flex justify-content-between">
                    <p style="white-space: nowrap;"><b>Totaal bedrag</b></p>
                    <p>€ {{ number_format($quotation->amount_with_vat, 2, '.', ' ') }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="page">
        <div class="row mb-4">
            ...
            <div class="col-7 text-end">
                ...
                <p class="text-right"><small>{{ $quotation->created_at->format('d/m/Y') }}</small></p>
            </div>
        </div>
            ...
            <ol>
                ...
                <li>
                    <small>
                        ...
                        Tarieven door BMK Solutions BV meegedeeld met het oog op dienstverlening zijn vastgelegd in functie
                        van prestaties.
                    </small>
                </li>
                <li>
                ...
                <li>
                    <small>
                        ...
                        dient door de klant binnen de 8 werkdagen vanaf de levering der goederen of de begindatum van het
                ...
                <li>
                    <small>
                        ...
                        dan wel die daaruit voortvloeien, berusten uitsluitend bij BMK Solutions BV of diens leveranciers.
                ...
                <li>
                    <small>
                        De klant zal niet zonder voorafgaande schriftelijke toestemming van BMK Solutions BV de producten
                        en
                        resultaten van de
                ...
                <li>
                    <small>
                        BMK Solutions BV behoudt zich het recht voor elk van deze voorwaarden en bepalingen op eender welk
                ...
                <li>
                    <small>
                        ...
                        Elk geschil dat in verband staat met de overeenkomsten gesloten met BMK Solutions BV zal exclusief
                ...
                <li>
                    <small>
                        ...
                        blijven eigendom van BMK Solutions BV zolang de volledige prijs (hoofdsom, kosten en intresten) niet
                        betaald is.
                    </small>
                </li>
                <li>
                ...
                <li>
                    <small>
                        ...
                        de titels, keuze van illustraties, media, enz., en verbindt er zich daarenboven toe BMK Solutions
                        BV
                ...
                <li>
                    <small>
                        De broncode en database blijven het exclusieve eigendom van BMK Solutions BV of haar licentiegever,
                ...
                <li>
                    <small>
                        Een voorschot kan bepaald worden bij ondertekening van de offerte. BMK Solutions BV heeft het recht
                ...
                <li>
                    <small>
                        De klant zal BMK Solutions BV telkens vrijwaren voor eventuele aanspraken van derden ingevolge de
                ...
                <li>
                    <small>
                        ...
                        door BMK Solutions BV. Op eerste verzoek van BMK Solutions BV zal de klant BMK Solutions BV hiervoor
                        ...
                        verband houdt.
                        Spamming is op al de door BMK Solutions BV ter beschikking gestelde apparatuur en systemen streng
                        verboden en lijdt tot directe afsluiting.
                        De klant verzekert onmiddellijk gevolg te geven aan elk verzoek van BMK Solutions BV alsook aan elk
                        ...
                        Zo laat BMK Solutions BV bij wijze van voorbeeld op haar servers geen pornografisch materiaal toe,
                        ...
                        dan wel welke een onrechtmatige praktijk uitmaken, evenmin mogen van op servers van BMK Solutions
                ...
                <li>
                    <small>
                        In geen geval is BMK Solutions BV aansprakelijk voor onrechtstreekse schade zoals o.a. commerciële
                        ...
                        derden ondernomen tegen de klant. BMK Solutions BV kan zo op geen enkele wijze aansprakelijk worden
