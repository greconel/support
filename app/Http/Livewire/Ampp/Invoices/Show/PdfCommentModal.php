...
class PdfCommentModal extends Component
{
    ...
    protected $rules = [
        'invoice.pdf_comment' => ['nullable', 'string']
    ];
    ...
    public function updatePdfComment()
    {
        ...
        $this->dispatch('refreshInvoice')->to('ampp.invoices.show.pdf-comment');

    }

    public function render(): View
    {
        return view('livewire.ampp.invoices.show.pdf-comment-modal');
    }
}
