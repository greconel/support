...
return [
    ...
    'laravel' => [
         ...
         */
        'docs_url' => '/app/api/documentation',
        ...
        'middleware' => [
            'web',
            'auth',
            'role_or_permission:super admin|api documentation',
        ],
    ],
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'You can retrieve your token by visiting the authentication section <a href="http://ampp.test/app/api/documentation#authentication">here</a> or by creating a personal access token on your profile page <a href="http://ampp.test/app/profile/tokens">here</a>.',
    ],
